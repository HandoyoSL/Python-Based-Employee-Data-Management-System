...
def input_departemen(data_karyawan):
    while True:
      ...
      if not membuatkodebaru(data_karyawan, departemen_baru):
        print()
...
def input_nama_karyawan(data_karyawan):
    while True:
      ...
      if nama_baru == 'Q':
        return None
      if nama_karyawan_baru(data_karyawan, nama_baru):
        return nama_baru
      else:
        print()
...
def input_nomor_ktp(data_karyawan):
    while True:
      print()
      nomor_ktp_baru = input("Masukan nomor KTP (16 Angka) -(Jika anda tidak melanjutkan proses tekan 'q')- : ")
      if nomor_ktp_baru == 'Q':
        return None
      if nomor_ktp_karyawan_baru(data_karyawan, nomor_ktp_baru):
...
def input_jabatan(data_karyawan):
    while True:
      ...
      if jabatan_karyawan_baru(data_karyawan, jabatan_baru):
        return jabatan_baru
      else:
        print()
...
def input_tgl_mulai_kerja(data_karyawan):
    while True:
      print()
      tgl_mulai_kerja_baru = input("Masukan tanggal mulai kerja (dd-mm-yyyy) -(Jika anda tidak melanjutkan proses tekan 'q')- : ")
      if tgl_mulai_kerja_baru == 'Q':
        return None
      if tgl_mulai_kerja_karyawan_baru(data_karyawan, tgl_mulai_kerja_baru):
...
def input_gaji_pokok(data_karyawan):
    while True:
      print()
      gaji_pokok_baru = input("Masukan gaji pokok (contoh : 10.000.000) -(Jika anda tidak melanjutkan proses tekan 'q')- : ")
      gaji_pokok_baru_replace = gaji_pokok_baru.replace(".", "")
      if gaji_pokok_baru == 'Q':
        return None
      if gaji_pokok_karyawan_baru(data_karyawan, gaji_pokok_baru_replace):
        return gaji_pokok_baru_replace
      else:
        print()
...
def input_status_pekerjaan(data_karyawan):
    while True:
      ...
      if status_pekerjaan_baru == 'Q':
        return None
      if status_pekerjaan_karyawan_baru(data_karyawan, status_pekerjaan_baru):
...
def input_pendidikan_terakhir(data_karyawan):
    while True:
      ...
      if pendidikan_terakhir_baru == 'Q':
        return None
      if pendidikan_terakhir_karyawan_baru(data_karyawan, pendidikan_terakhir_baru):
...
def input_nomor_telepon(data_karyawan):
    while True:
      print()
      nomor_telepon_baru = input("Masukan nomor telepon (Dimulai dengan 08...) -(Jika anda tidak melanjutkan proses tekan 'q')- : ")
      if nomor_telepon_baru == 'Q':
          return None
      if nomor_telepon_karyawan_baru(data_karyawan, nomor_telepon_baru):
...
def input_alamat(data_karyawan):
    while True:
      ...
      if alamat_baru == 'Q':
        return None
      if alamat_karyawan_baru(data_karyawan, alamat_baru):
        return alamat_baru
      else:
        print()
...
def input_email(data_karyawan):
    while True:
      ...
      if email_baru == 'q':
        return None
      if email_karyawan_baru(data_karyawan, email_baru):
        return email_baru
      else:
        print()
...
def input_status_pernikahan(data_karyawan):
    while True:
      ...
      if status_pernikahan_baru == 'Q':
        return None
      if status_pernikahan_karyawan_baru(data_karyawan, status_pernikahan_baru):
...
def input_jumlah_anak(data_karyawan):
    while True:
      ...
      if anak_baru == 'q':
        return None
      if anak_karyawan_baru(data_karyawan, anak_baru):
        return anak_baru
      else:
        print()
...
def input_bpjs_kesehatan(data_karyawan):
    while True:
      ...
      if bpjs_kesehatan_baru == 'Q':
        return None
      if bpjs_kesehatan_karyawan_baru(data_karyawan, bpjs_kesehatan_baru):
...
def input_bpjs_ketenagakerjaan(data_karyawan):
    while True:
      ...
      if bpjs_ketenagakerjaan_baru == 'Q':
        return None
      if bpjs_ketenagakerjaan_karyawan_baru(data_karyawan, bpjs_ketenagakerjaan_baru):
...
def gaji_pokok_karyawan_baru(data_karyawan, gaji_pokok_baru):
  ...
  if re.match("[0-9]{1,10}", gaji_pokok_baru_replace):
    return True
  else:
    print()
...
def nomor_telepon_karyawan_baru(data_karyawan, nomor_telepon_baru):
  nomor_telepon_baru_replace = nomor_telepon_baru.replace(" ","")
  if re.match("08[0-9]{8,11}", nomor_telepon_baru_replace): # Memastikan nomor telepon valid dan diawali dengan '08'
    return True
  else:
    print()
...
def bpjs_kesehatan_karyawan_baru(data_karyawan, bpjs_kesehatan_baru):
  if bpjs_kesehatan_baru in ["Aktif", "Tidak Aktif"]:  # Memastikan input adalah salah satu dari pilihan
    return True
  else:
    print()
...
def bpjs_ketenagakerjaan_karyawan_baru(data_karyawan, bpjs_ketenagakerjaan_baru):
  ...
  if bpjs_ketenagakerjaan_baru in ["Aktif", "Tidak Aktif"]:  # Memastikan input adalah salah satu dari pilihan
    return True
  else:
    print()
...
def edit_data(data_karyawan):
    while True:
        ...
        if namakaryawan(data_karyawan, nama_karyawan_asli):
            if cekkode(data_karyawan, kode_karyawan_asli):
                for search in data_karyawan:
                    if search["kode_karyawan"] == kode_karyawan_asli and search["nama_lengkap"] == nama_karyawan_asli:
                        while True:
                            ...
                            # Memanggil fungsi-fungsi yang ada di create
                            if input_edit == "1":
                              nama_karyawan = input_nama_karyawan(data_karyawan)
                              ...
                              if bertanya == "Tidak":
                                  return
                            # Melakukan edit pada departemen orang yang dipilih
                            elif input_edit == "3":
                              departemen_baru = input_departemen(data_karyawan)
                              if departemen_baru is None:
                                return  # Keluar dari loop edit
...
def cekkode(data_karyawan, kode_karyawan_asli):
    ...
    if re.match("[A-Z]{2,3}[0-9]{3}", kode_karyawan_asli):
        ...
        if kode_pisah:
            ...
            contoh_kode_asli = contoh_kode[huruf]
...
def restore_data(data_karyawan):
    ...
    for entry in history_delete:
        if entry["kode_karyawan"] == kode_karyawan:
            ...
            if any(k["kode_karyawan"] == kode_karyawan for k in data_karyawan):
                # Jika sudah ada, buat kode baru
                new_code = generate_new_code(data_karyawan, kode_karyawan)
...
def generate_new_code(data_karyawan, kode_karyawan):
    # Mendapatkan awalan kode (misal "KEU" dari "KEU001")
    kode_departemen = kode_karyawan[:3]
    nomor_terakhir = 0

    # Mencari nomor terakhir yang sudah ada di data_karyawan
    for karyawan in data_karyawan:
        if karyawan["kode_karyawan"].startswith(kode_departemen):
            nomor = int(karyawan["kode_karyawan"][3:])  # Mengambil bagian nomor dari kode
            if nomor > nomor_terakhir:
                nomor_terakhir = nomor

    # Membuat kode baru
    new_code = f"{kode_departemen}{nomor_terakhir + 1:03d}"  # Menambahkan 1 dan format ke 3 digit
    return new_code
...
def main():
    while True:
        ...
        print("8. Restore Data Karyawan")  # Menu baru
        print("9. Keluar")
        ...
        elif choice == '8':  # Pilihan baru
            restore_data(data_karyawan)
        elif choice == '9':
